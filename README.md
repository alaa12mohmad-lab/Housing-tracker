...
## نقطتين لسه مفتوحتين (اتكلمنا عليهم قبل كده ومحتاجين قرار)
1. **قروض اللودر عبر حساب وسيط** — ده جزء من نظام هنا أكاونتنج مش من التطبيق ده، لسه معلق هناك.
2. لو حبيت تضيف تنبيهات فواتير الكهرباء/المياه نفسها (مش بس الإيجار) لاحقًا، الهيكل جاهز لإضافتها بسهولة في `dashboard.js`.
